...
public class SingleSourceShortestPath {
    ...
    public static int[] shortestPath(int n, int[][] edges, int src) {
        ...
        Arrays.fill(distance, -1); // Initially all distances are unreachable (-1)
        distance[src] = 0; // Distance to itself is zero
    ...
    public static void main(String[] args) {
        ...
        int src1 = 1;
        System.out.println("Shortest Path from Vertex " + src1 + ": " + Arrays.toString(shortestPath(n1, edges1, src1)));
        ...
        int src2 = 0;
        System.out.println("Shortest Path from Vertex " + src2 + ": " + Arrays.toString(shortestPath(n2, edges2, src2)));
        // Expected Output: [0, 1, -...,...]
