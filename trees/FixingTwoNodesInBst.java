...
public class FixingTwoNodesInBst {
    ...
    public static void main(String[] args) {
        FixingTwoNodesInBst obj=new FixingTwoNodesInBst();
        Node root=new Node(10);
        root.left=new Node(5);
        root.right=new Node(8);
        root.left.left=new Node(2);
        root.left.right=new Node(20);
        System.out.println("intial inorrder of tree is");
        obj.printInorder(root);
        obj.correctBST(root);
        System.out.println("\nInorder of tree after fixing is");
        obj.printInorder(root);
    }
}
